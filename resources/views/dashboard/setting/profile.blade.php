                ...
                @if (Auth::user()->google2fa_secret)
                    <form method="POST" action="{{ route('2fa.disable') }}">
                        ...
                        <div class="alert alert-info">
                            <p>2FA Aktif — kamu menggunakan Google Authenticator.</p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ route('dashboard.settings.profile.update') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mx-auto">
                                            <div class="form-group">
                                                ...
                                                <img width="120px" id="profilepreview" height="120px"
                                                    src="{{ asset('uploads/author/' . ($user->profile ?? 'default.webp')) }}"
                                                    class="d-block rounded rounded-circle mb-2" />
                                        ...
                                        <div class="col-md-6 mx-auto">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="url" class="form-control" id="instagram"
                                                    name="instagram" placeholder="Enter instagram profile link"
                                                    value="{{ $user->instagram }}" />
                                            </div>
                                            <div class="form-group">
                                                <label for="linkedin">LinkedIn</label>
                                                <input type="url" class="form-control" id="linkedin"
                                                    name="linkedin" placeholder="Enter linkedin profile link"
                                                    value="{{ $user->instagram }}" />
                                            </div>
                                            <div class="form-group">
